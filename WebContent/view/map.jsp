...
<form action = "map.jsp" name = "reg" method = "POST">
<div class = "cordinate">
...
<div class = don>
	<button  id = "donazione" name = "donazione" style="visibility:hidden;position: absolute; top:35%; left: 1%; border: 1px solid red; background: red; color:white; height:40px;width:150px; font-weight:bold; font-size: 14px;" >CREA DONAZIONE</button> 
</div>
	...
	<button id = "turno" name = "turno" style="visibility:hidden;position: absolute; top:49%; left: 1%; border: 1px solid red; background: red; color:white; height:40px; width:150px; font-weight:bold; font-size: 14px;">PRENOTA TURNO</button> 
	<button id = "partecipaEvento" name = "partecipaEvento" style="visibility:hidden;position: absolute; top:35%; left: 1%; border: 1px solid red; background: red; color:white; height:40px; width:150px; font-weight:bold; font-size: 14px;">PARTECIPA EVENTO</button>
	
	 <div class = "ind">
        <a href= "homeVolontario.jsp">INDIETRO</a>
    </div>
