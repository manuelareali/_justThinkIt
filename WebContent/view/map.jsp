...
<body>
	...
	<form action="map.jsp" name="reg" method="POST">
		...
		<button id="necessita" name="necessita"
		...
		<button id="turno" name="turno"
			...
			TURNO</button>
		<button id="partecipaEvento" name="partecipaEvento"
		...
		<button id="necessita" name="necessita"
			style="visibility: hidden; position: absolute; top: 42%; left: 1%; border: 1px solid red; background: red; color: white; height: 40px; width: 150px; font-weight: bold; font-size: 14px;">VEDI
			BACHECA</button>
		<button id="promuoviEvento" name="promuoviEvento"
	...
	<div class="check">
		<div>
			<input type="checkbox" class="gaucher" id="1" name="gaucher[]"
				onClick="actionCaritas()" onchange="processCheck(this)"> <label
				for="1">Caritas</label>
		</div>
		<div>
			<input type="checkbox" class="gaucher" id="2" name="gaucher[]"
				onClick="actionPartecipaEvento()" onchange="processCheck(this)">
			<label for="2">Eventi</label>
		</div>

		<div>
			<input type="checkbox" class="gaucher" id="3" name="gaucher[]"
				onchange="processCheck(this)"> <label for="3">Donazioni</label>
		</div>
		<div>
			<input type="checkbox" class="gaucher" id="4" name="gaucher[]"
				onchange="processCheck(this)"> <label for="4">MioMarker</label>
		</div>
	</div>
	...
	<%
			...
			System.out.println("Stringa non valida nell'argomento");
		}
	}
