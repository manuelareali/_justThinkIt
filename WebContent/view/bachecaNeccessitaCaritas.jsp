...
<body>
<form action = "bachecaNeccessitaCaritas.jsp" name ="my" method = "POST">
...
%>
			...
			<div class = "elimina">
				...
				<input type="text" id = "id_necessità" name= "id_necessità"   placeholder="Inserisci l'ID della necessità da eliminare">
			</div>
			<div class = "ind">
